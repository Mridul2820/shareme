...
const CreatePin = ({ user }) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
            {fields && 
                <p className="mb-5 text-red-500 text-xl transition-all duration-150 ease-in">
                    Please Fill in all the Fields
                </p>
            }
            <div className="flex flex-col lg:flex-row justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
                <div className="bg-secondaryColor p-3 w-full flex-0.7">
                ...
                <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
                    ...
                    <div className="flex flex-col">
                        <div>
                            <p className="mb-2 ml-2 font-semibold text:lg sm:text-xl">Choose Pin Category</p>
                            <select
